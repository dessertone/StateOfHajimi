...
using CollectSystem = StateOfHajimi.Core.Systems.RenderSystem.CollectSystem;
...
public class GameContext:IDisposable,IGameContext
{
    ...
    /// 网格地图
    /// </summary>
    public TileMap Map { get; set; } = new (150, 150, 50);
    ...
    public GameContext()
    {
        ...
        GameWorld.SetSingleton(debugSettings);
        
        GenerateDemoMap(Map);
        new MapLoaderSystem(GameWorld, Map).LoadMap(Map);
        FlowFieldManager.Instance.Initialize(Map);
